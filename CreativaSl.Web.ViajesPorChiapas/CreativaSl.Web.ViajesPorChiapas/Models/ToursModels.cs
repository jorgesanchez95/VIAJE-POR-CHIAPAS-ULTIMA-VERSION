...
namespace CreativaSl.Web.ViajesPorChiapas.Models
{
    public class ToursModels
    {
        ...
        [Remote("CheckNameToursAvailability", "CatTours", ErrorMessage = "El nombre de la Imagen ya esta asignado")]
        ...
        [Remote("CheckNombreESToursAvailability", "CatTours", ErrorMessage = "El nombre ya esta asignado")]
        ...
        public DataTable tablaTours { get; set; }
        ...
        [Required(ErrorMessage = "El correo es obligatorio")]
        [Display(Name = "Correo")]
        [StringLength(30000, ErrorMessage = "El número de caracteres de {0} debe ser al menos {2} y máximo {1}.", MinimumLength = 1)]
        [RegularExpression(@"^[_A-Za-z0-9.-\\+]+(\\.[_A-Za-z0-9-]+)*@" + "[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$", ErrorMessage = "Correo no Valido")]
        ...
        private List<ToursModels> _tablaToursCmb;
        [Required(ErrorMessage = "Tours es un campo requerido")]
        [Display(Name = "Tours")]
        public List<ToursModels> tablaToursCmb
        {
            get { return _tablaToursCmb; }
            set { _tablaToursCmb = value; }
        }
