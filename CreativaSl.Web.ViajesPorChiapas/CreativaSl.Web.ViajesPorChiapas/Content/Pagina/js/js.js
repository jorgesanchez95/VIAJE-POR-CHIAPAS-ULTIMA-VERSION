...
jQuery(document).ready(function($) {
   ...
   if (jQuery().owlCarousel) {
       if (jQuery("#post-valores").length) {
           jQuery("#post-valores").owlCarousel({
               loop: true,
               margin: 0,
    	...
    	/*COMENTARIOS ss*/
    	if (jQuery("#post-comentarios").length){
			jQuery("#post-comentarios").owlCarousel({
				loop:true,
				margin:0,
				responsiveClass:true,
				autoplay:false,
...
$(function() {
		...
		$( "#adult_count,#adult_count1,#adult_count2" ).spinner({
			min: 1
		});
		$( "#child_count" ).spinner( {
			min: 1
